...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <!--主要区域开始-->
        <div id="main">
            <div id="add_success_info" class="save_success">修改成功！</div><!--保存失败，数据并发错误！-->
            <div id="add_fail_info" class="save_fail">修改失败！</div>
            <form action="" method="" class="main_form">
                    <div class="text_info clearfix"><span>姓名：</span></div>
                    <div class="input_info">
                        <input type="text" value="${userInfo.uname}" id="uname" />
                        <span class="required">*</span>
                        <%--<div class="validate_msg_long error_msg">20长度以内的汉字、字母、数字的组合</div>--%>
                    </div>
                    <div class="text_info clearfix"><span>管理员账号：</span></div>
                    <div class="input_info"><input type="text" readonly="readonly" class="readonly" value="${userInfo.uid}" id="uid" /></div>
                    <div class="text_info clearfix"><span>电话：</span></div>
                    <div class="input_info">
                        <input type="text" value="${userInfo.utel}" id="utel" />
                        <span class="required">*</span>
                        <%--<div class="validate_msg_long error_msg">正确的电话号码格式：手机或固话</div>--%>
                    </div>
                    <div class="text_info clearfix"><span>Email：</span></div>
                    <div class="input_info">
                        <input type="text" class="width200" value="${userInfo.uemail}" id="uemail"/>
                        <span class="required">*</span>
